...
final movieList2 = [
  ...
  Movie(
      ...
      description: 'When Ros is positively pregnant, Tiar decides to go to Jakarta with his friends Sakka and Dodi to find work as well as looking for his father family who is said to be rich in Jakarta to ...',
      rating: 'Comin Soon',
      year: '2020',
      duration: '??? min'
  ),
